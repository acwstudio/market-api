...
| slug          | string | -            | tomskij-institut-biznesa | slug          |
| product_id    | string | -            | 17                       | id продукта |
...
| city_ids         | array int[] | -            | [1,2,3]                               | Массив идентификаторов городов     |
...
| color_text      | string      | -            | #00ff00             | Цвет текста в шестнадцатеричном формате |
| color_bg_list   | string      | -            | primary             | Цвет фона список                        |
| color_text_list | string      | -            | default             | Цвет текста список                      |
...
| slug          | string | -            | another_landing | slug          |

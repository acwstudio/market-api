...
//        FIELD_LOGO = 'logo',
        ...
        FIELD_IS_STATE = 'is_state',
        FIELD_IS_MILITARY_CENTER = 'is_military_center',
        FIELD_IS_HOSTEL = 'is_hostel',
        FIELD_COST_YEAR_STUDY = 'cost_year_study',
        FIELD_BUDGET_PLACES = 'budget_places',
        FIELD_BUDGET_YEAR = 'budget_year',
        FIELD_BUDGET_POINTS = 'budget_points',
        FIELD_CONTRACT_PLACES = 'contract_places',
        FIELD_CONTRACT_YEAR = 'contract_year',
        FIELD_CONTRACT_POINTS = 'contract_points',
    ...
    public $fillable = [
        ...
        self::FIELD_IS_STATE,
        self::FIELD_IS_MILITARY_CENTER,
        self::FIELD_IS_HOSTEL,
        self::FIELD_COST_YEAR_STUDY,
        self::FIELD_BUDGET_PLACES,
        self::FIELD_BUDGET_YEAR,
        self::FIELD_BUDGET_POINTS,
        self::FIELD_CONTRACT_PLACES,
        self::FIELD_CONTRACT_YEAR,
        self::FIELD_CONTRACT_POINTS,
        self::FIELD_ADDRESS,
        self::FIELD_MAP_LINK,

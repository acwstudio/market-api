...
final class ProductResource extends JsonResource
{
    ...
    public function toArray($request): array
    {
        ...
        return [
            ...
            Product::FIELD_EXPIRATION_DATE             => $product->getDateTimeDisplay(Product::FIELD_EXPIRATION_DATE),
            ...
            Product::FIELD_START_DATE                  => $product->getDateTimeDisplay(Product::FIELD_START_DATE),
